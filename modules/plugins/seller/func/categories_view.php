         ...
         <td align="right">
            ...
            <tr>
             <td class="smallText" align="right">
                <?php 
                    echo os_draw_form('search', 'plugins_page.php', 'page=seller_add_page&', 'get'); 
            ...
            <tr>
             <td class="smallText" align="right">
                <?php 
                    echo os_draw_form('goto', 'plugins_page.php', 'page=seller_add_page&', 'get');
...
<?php
    ...
    switch (@$_GET['action']) {        
      ...
      case 'copy_to':
        ...
        $contents   = array('form' => os_draw_form('copy_to', 'plugins_page.php', 'page=seller_add_page&action=copy_to_confirm&cPath=' . $cPath) . os_draw_hidden_field('products_id', $pInfo->products_id));
