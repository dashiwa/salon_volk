...
if ($result != false) {
	...
	{
	   $error = 'Нет продавцов для данного региона.<br>'.zone_id_param_filter('');
	}
	elseif ( get_cat( array(21) ) == true )
	{
	   $error = 'Нет услуг для данного региона.<br>'.zone_id_param_filter('');
	}
	else
	{
	    $error = 'Нет товаров для данного региона.<br>'.zone_id_param_filter('');
