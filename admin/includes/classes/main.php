    ...
    */
    ...
    class main {
        ...
        function bottom()
        {
            ...
            _e ('<center><span style="font-size:12px;color:#3366CC;font-family: Verdana,Arial,sans-serif;font-size: 12px;font-weight: normal;">&copy; '.date('Y').' ShopOS</span><br /><a href="http://www.shopos.ru/buy/" target="_blank" title="Купить интернет-магазин" style="font-size:12px;color:#3366CC;">Купить интернет-магазин</a></center>');
