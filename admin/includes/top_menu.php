<?php
    ...
    */
	...
	$menu_value[2]['value'] = 'Продавцы';    
    $menu_value[2]['url'] = '#';	

	$menu_value[2]['child'] = array (
    array('value'=> 'Импорт', 'url' => 'plugins_page.php?main_page=seller_import_page1')
    );

    $menu_value[3]['value'] = BOX_HEADING_CUSTOMERS;    
    $menu_value[3]['url'] = FILENAME_ORDERS;
    ...
    //4 Настройки
    $menu_value[4]['value'] = BOX_HEADING_CONFIGURATION;    
    $menu_value[4]['url'] = FILENAME_CONFIGURATION.'?gID=1';	
    ...
    $menu_value[5]['value'] = BOX_HEADING_ADDONS;	
    $menu_value[5]['url'] = FILENAME_MODULES;	
    ...
    $menu_value[6]['value'] = BOX_HEADING_OTHER;	
    $menu_value[6]['url'] = FILENAME_BACKUP;	
    ...
    $menu_value[7]['value'] = BOX_HEADING_HELP;    
    $menu_value[7]['url'] = 'http://docs.shopos.ru/';	
    //справка
    $menu_value[7]['child'] =  array(
    array('value' => BOX_HELP, 'url' => 'http://docs.shopos.ru/'),
    array('value' => BOX_SUPPORT_SITE, 'url' => 'http://www.shopos.ru/'),
    array('value' => BOX_THEMES_URL, 'url' => 'http://www.shopos.ru/themes/'),
    array('value' => BOX_SUPPORT_FORUM, 'url' => 'http://www.shopos.ru/forum/'),
    array('value' => 'Хостинг', 'url' => 'http://www.shopos.ru/hosting/')
    );	
    ...
    {
        $menu_value[1]['child'][] = 
        array('value'=> BOX_PARAMETERS_PLUG,'url'=> FILENAME_PLUGINS_PAGE.'?main_page=param_add',
        'child' => array(
        array('value'=> BOX_PARAMETERS_PLUG, 'url'=> FILENAME_PLUGINS_PAGE.'?main_page=param_add'),
        array('value'=> BOX_PARAMETERS_OPTIONS_PLUG, 'url' => FILENAME_PLUGINS_PAGE.'?main_page=param_options'),
        array('value'=> BOX_PARAMETERS_TOOLS_PLUG, 'url' => FILENAME_PLUGINS_PAGE.'?main_page=param_tools')
        )
        );
    }
...
?>
<ul class="shopos-version">
    <li><img src="images/favicon.png" style="float:left" border="0" /><a href="http://www.shopos.ru/" target="_blank" class="version" title="<?php echo $_rev;?>">ShopOS <?php echo $_version; ?></a></li>
</ul>
