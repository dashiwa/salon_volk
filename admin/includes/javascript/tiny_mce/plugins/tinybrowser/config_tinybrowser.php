...
$tinybrowser['path']['image'] = CATALOG.'images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = CATALOG.'media/content/'; // Media files location
$tinybrowser['path']['file']  = CATALOG.'media/content/'; // Other files location
