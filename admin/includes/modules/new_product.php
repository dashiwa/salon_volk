...
<!-- info -->
        ...
        <h3><?php echo TEXT_PRODUCTS_DATA; ?></h3>
		 ...
		 <tr>
            <td valign="top" class="main"><?php echo 'Регион';?></td>			
			<td valign="top" class="main">
			<?php echo os_draw_pull_down_menu('zone_id', get_zone_block('array'), $pInfo->zone_id); ?>
			</td>
          </tr>
...
<?php
 if ( apply_filter('check_image_tab', 'true') == 'true')
 {
?>
<div class="tabbertab">
