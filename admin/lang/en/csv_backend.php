...
define('SELECT','Select Import file (/media/import Folder)');
define('SAVE','Save file in /media/export Folder');
...
define('TEXT_EXPORT','Create exportfile and save in /media/export Folder');
?>