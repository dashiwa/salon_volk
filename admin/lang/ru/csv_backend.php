...
define('SELECT','Выберите файл для импорта (папка /media/import)');
define('SAVE','Сохранить файл в папку /media/export');
...
define('TEXT_EXPORT','Создать файл и сохранить его в папке /media/export');
