...
define('ERROR_CATALOG_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Ошибка: Каталог картинок защищён от записи. Установите права доступа на запись для данного каталога: ');
define('ERROR_CATALOG_IMAGE_DIRECTORY_DOES_NOT_EXIST', 'Ошибка: Каталог картинок отсутствует: ');
...
define('TEXT_ARTICLE_PAGE_URL', 'ЧПУ URL статьи:');
define('TEXT_TOPIC_PAGE_URL', 'ЧПУ URL категории:');
