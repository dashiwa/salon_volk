<?php /* Smarty version 2.6.24, created on 2016-09-02 03:23:35
         compiled from silver/module/create_account.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'silver/module/create_account.html', 1, false),)), $this); ?>
...
<?php endif; ?>
  <tr>
    <td class="mod_th" colspan="2"><?php echo $this->_config[0]['vars']['title_password']; ?>
</td>
  </tr>
  <tr>
    <td class="mod_tdb"><label for="pass" title="<?php echo $this->_tpl_vars['ENTRY_PASSWORD_ERROR']; ?>
"><?php echo $this->_config[0]['vars']['text_password']; ?>
  ...
  <tr>
    <td class="mod_tdb"><label for="confirmation" title="<?php echo $this->_tpl_vars['ENTRY_PASSWORD_ERROR_NOT_MATCHING']; ?>
"><?php echo $this->_config[0]['vars']['text_confirmation']; ?>
</label></td>
    <td class="mod_td2"><?php echo $this->_tpl_vars['INPUT_CONFIRMATION']; ?>
</td>
  </tr>
</table>
</div>
